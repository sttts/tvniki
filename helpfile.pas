...
var
  CrossRefHandler: TCrossRefHandler;
...
begin
  ...
  if Pointer(@CrossRefHandler) = Pointer(@NotAssigned) then
...
{ Pure Pascal replacement for x86 assembly - copy bytes to string }
var
  Buf: PByteArray;
  Idx: Integer;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      for J := 0 to L-1 do
        Int64Rec(B[KeyPoint.X - Delta.X + J]).Hi := C;
      Inc(KeyCount);
