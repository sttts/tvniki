...
{$ifdef experimental}
  ...
  {not $define UserFuncs}
    {noch nicht komplett implementiert:
     überall innerhalb der Function muß der Name gültig sein,
     um einen Rückgabewert zu liefern

     -> die Prozedur "Befehl" muß erweitert werden, daß Sie Konstrukte wie
     "Func := TRUE" verarbeitet

     -> Die Prozedur "Befehl" muß durch "Anweisung ersetzt werden, die
     später z.B. auch Rechnungen verarbeiten kann.
    }
{$endif}
